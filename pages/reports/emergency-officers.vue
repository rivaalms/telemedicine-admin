   ...
   <div class="grid grid-cols-12 gap-4 mb-4">
      ...
      <div class="col-start-11 col-span-2 flex justify-end items-end">
         <u-button
            ...
            @click.stop="useExportExcel('EmergencyOfficers', filter)"
         >
            Export Excel
         </u-button>
      </div>
   ...
   <div class="relative overflow-x-auto">
      <table class="min-w-full table-fixed divide-y divide-gray-300 dark:divide-gray-700" id="dataTable">
         <thead>
            <tr>
               <th
                  v-for="item in useEmergencyOfficerReportsTableHeader"
...
import { getEmergencyOfficers } from '@/utils/api/reports'
import VueDatePicker from '@vuepic/vue-datepicker'
import '@vuepic/vue-datepicker/dist/main.css'
import moment from 'moment'

const store = useAppStore()
store.title = 'Laporan Driver Emergency'
...
const fetchEmergencyOfficers = async () => {
   ...
   await getEmergencyOfficers(payload)
      .then((resp) => {
